...
ed = np.matrix([[.293694398621, -.122202442352, .105926875934, 2.220321396090, -2.197400976034, -.008928417774]]).T
...
transform = forward_kinematic_solution(DH_matrix_UR3e)

pose = np.matrix([.293694398621, -.122202442352, .105926875934, 1]).T

print(transform * pose)

# transform = forward_kinematic_solution(DH_matrix_UR3e, ed)
print("Forward")
print(transform)
...
print("Inverse")
IKS = inverse_kinematic_solution(DH_matrix_UR3e, transform)
